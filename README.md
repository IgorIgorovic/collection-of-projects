...
## 8.Джерело високої напруги
Джерело високої напруги (біля 200 V максимум) являє собою змінену схему простого підвищувального перетворювача, відомого як «крадій джоулів». збільшено кількість витків обмотки, підключеної до бази транзистора, до двохсот, і використано два високовольтних транзистора 13003D, ввімкнувши їх в схему таким чином, щоб підсилений струм з емітера першого транзистора подавався на базу другого, адже підсилення струму в цього транзистора невелике. Друга обмотка підключена до бази першого транзистора через резистор 3300 Ом. До кінця першої обмотки (високовольтний вихід) можна підключити діод і конденсатор для накопичення енергії. Транзистори 13003D можна знайти у більшості люмінісцентних ламп під цоколь E27 або інший цоколь типу E, тому це робить ці транзистори доступнішими.
 Схема:
...
L2 – 200 витків
Осердя з фериту
D1 – IN4007 або інший діод
С1 – 400 V, від 2 нФ і більше

За допомогою цього генератора можна змусити працювати зарядний пристрій для смартфону, хоча для цього потрібен великий струм на вході генератора. Також генератор може живити неонову лампу, розраховану на 220 V, або використовуватись для створення потужних імпульсів, наприклад, для освітлення спалахом.
![image](photo1.jpg)
![image](photo2.jpg)
